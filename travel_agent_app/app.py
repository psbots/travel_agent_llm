...
from graph import graph_runnable  # Import the LangGraph runnable
...
# st write magic
# """
# Where would you like to go? For how many days?
# ---
# """
...
if "messages" not in st.session_state:
    ...
    st.session_state["messages"] = [AIMessage(content="Hello! Please mention where you'd like to go and any specific requirements if any")]
...
if prompt := st.chat_input():
    ...
    with st.chat_message("assistant"):
        ...
        response = graph_runnable.invoke({"task": prompt, "max_revisions": 2, "revision_number": 1}, config={"callbacks": [st_callback]})
        ...
        st.session_state.messages.append(AIMessage(content=response["draft"]))
